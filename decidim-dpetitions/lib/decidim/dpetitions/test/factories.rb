...
FactoryBot.define do
  factory :dpetition, class: "Decidim::Dpetitions::Dpetition" do
    ...
    component { build(:component, manifest_name: "dpetitions") }
  ...
  factory :dpetitions_component, parent: :component do
